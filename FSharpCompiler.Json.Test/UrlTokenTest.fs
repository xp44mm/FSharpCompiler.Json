...
type UrlTokenTest(output:ITestOutputHelper) =
    ...
    member this.json() =
        ...
        let res = [LEFT_PAREN;KEY "inlet";EXCLAM;LEFT_PAREN;KEY "SO2";EXCLAM;NUMBER 0.0;ASTERISK;KEY "SO3";EXCLAM;NUMBER 1.0;RIGHT_PAREN;ASTERISK;KEY "eobj";EXCLAM;LEFT_PAREN;EXCLAM;RIGHT_PAREN;ASTERISK;KEY "earr";EXCLAM;LEFT_PAREN;RIGHT_PAREN;ASTERISK;KEY "arr";EXCLAM;LEFT_PAREN;NUMBER 10.0;ASTERISK;NUMBER 11.0;ASTERISK;NUMBER 12.0;RIGHT_PAREN;ASTERISK;KEY "dirtyLeakage";EXCLAM;STRING "Yes! \"it's great*\"";RIGHT_PAREN]
    ...
    member this.``simple tokens``() =
        ...
        //output.WriteLine(Render.stringify toks)
        let res = [LEFT_PAREN;LEFT_PAREN;NULL;ASTERISK;TRUE;ASTERISK;FALSE;RIGHT_PAREN;ASTERISK;LEFT_PAREN;EXCLAM;RIGHT_PAREN;ASTERISK;LEFT_PAREN;KEY "$";EXCLAM;NUMBER -110.0;ASTERISK;KEY "x'";EXCLAM;STRING "";RIGHT_PAREN;RIGHT_PAREN]
        Should.equal toks res
